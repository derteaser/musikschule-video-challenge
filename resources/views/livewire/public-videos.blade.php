<div>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 max-w-screen-xl mx-auto" id="publicVideos">
        @foreach($videos as $video)
            ...
            @endphp
            <div>
                <a href="https://player.cloudinary.com/embed/?cloud_name={{ Str::after(config('cloudinary.cloud_url'),'@') }}&public_id={{ $video->getPublicId() }}&controls=true" class="block relative group">

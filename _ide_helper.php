...
')
     ...
     */ 
        ...
        {
                        return \Kineticamobile\Lumki\Lumki::insertLineAfter($path, $needle, $replace);
        }
                    /**
         * 
         *
        ...
        {
                        return \Kineticamobile\Lumki\Lumki::insertLineBefore($path, $needle, $replace);
        }
                    /**
         * 
         *
        ...
        {
                        return \Kineticamobile\Lumki\Lumki::insertLine($path, $needle, $insert, $after);
        }
...
namespace  { 
            ...
            class Lumki extends \Kineticamobile\Lumki\Facades\Lumki {}
